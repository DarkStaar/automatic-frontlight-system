...
extern VAR(IdtDioValueType, RTE_VAR_NOINIT) Rte_CpSaSpeedometer_PpSpeedometerOut_DeSpeedometer; /* PRQA S 0850, 3408, 1504 */ /* MD_MSR_19.8, MD_Rte_3408, MD_MSR_8.10 */
...
typedef struct
{
  uint8 Rte_Trigger_My_Task_Rte_Trigger1_CpApAFSController_RCtApAFSControllerComM_ModeChange_FULL_COM_Entry;
  uint8 Rte_Trigger_My_Task_Rte_Trigger1_CpApAFSController_RCtApAFSControllerLogic;
...
#  define Rte_TriggerDisableMaxCount_My_Task_Rte_Trigger1_CpApAFSController_RCtApAFSControllerComM_ModeChange_FULL_COM_Entry 2
#  define Rte_TriggerDisableMaxCount_My_Task_Rte_Trigger1_CpApAFSController_RCtApAFSControllerLogic 1
