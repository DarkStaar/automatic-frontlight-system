...
#  define Rte_Call_PpBatteryLevelHwAbIn_ReadChannel(arg1) (RCtCddIoHwAb_PpBatteryLevelIoHwAb_ReadChannel(arg1), ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
FUNC(void, CtApBatteryManager_CODE) RctSaBatteryManager(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
