 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: Dio_Cfg.h
 *   Generation Time: 2023-03-12 21:19:20
 ...
 *  GLOBAL DEFINES
 **********************************************************************************************************************/
#define DIO_MAX_CHANNEL_COUNT       (4U)
#define DIO_MAX_PORT_COUNT          (2U)
...
#define DioConf_DioChannel_env_BatteryLevel_001    ((Dio_ChannelType) 3) 
