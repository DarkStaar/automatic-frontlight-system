 ...
 *  Generated at:  Sun Mar 12 23:39:09 2023
 *
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Read_CtApAFSController_PpSpeedometer_DeSpeedometer(P2VAR(IdtDioValueType, AUTOMATIC, RTE_CTAPAFSCONTROLLER_APPL_VAR) data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
FUNC(void, RTE_CODE) Rte_Enter_CtApAFSController_ExclusiveArea(void); /* PRQA S 0850 */ /* MD_MSR_19.8 */
FUNC(void, RTE_CODE) Rte_Exit_CtApAFSController_ExclusiveArea(void); /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
# define Rte_Enter_ExclusiveArea Rte_Enter_CtApAFSController_ExclusiveArea
# define Rte_Exit_ExclusiveArea Rte_Exit_CtApAFSController_ExclusiveArea
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: RCtApAFSControllerComM_FULL_COMM_Exit
 *
 *---------------------------------------------------------------------------------------------------------------------
 *
 * Executed if at least one of the following trigger conditions occurred:
 *   - triggered on exiting of Mode <COMM_FULL_COMMUNICATION> of ModeDeclarationGroupPrototype <currentMode> of PortPrototype <PpComMCurrentModeCtAFSController>
 *
 *********************************************************************************************************************/

# define RTE_RUNNABLE_RCtApAFSControllerComM_FULL_COMM_Exit RCtApAFSControllerComM_FULL_COMM_Exit
FUNC(void, CtApAFSController_CODE) RCtApAFSControllerComM_FULL_COMM_Exit(void); /* PRQA S 0850 */ /* MD_MSR_19.8 */

/**********************************************************************************************************************
 *
 * Runnable Entity Name: RCtApAFSControllerComM_ModeChange_FULL_COM_Entry
 *
 *---------------------------------------------------------------------------------------------------------------------
 *
 * Executed if at least one of the following trigger conditions occurred:
...
# define RTE_RUNNABLE_RCtApAFSControllerComM_ModeChange_FULL_COM_Entry RCtApAFSControllerComM_ModeChange_FULL_COM_Entry
FUNC(void, CtApAFSController_CODE) RCtApAFSControllerComM_ModeChange_FULL_COM_Entry(void); /* PRQA S 0850 */ /* MD_MSR_19.8 */
 ...
 *   - triggered on DataReceivedEvent for DataElementPrototype <DeSpeedometer> of PortPrototype <PpSpeedometer>
 *     and not in Mode(s) <BATTERY_LOW>
 ...
 *   Std_ReturnType Rte_Read_PpSpeedometer_DeSpeedometer(IdtDioValueType *data)
