...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: RCtApAFSControllerComM_FULL_COMM_Exit_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: RCtApAFSControllerComM_FULL_COMM_Exit
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: RCtApAFSControllerComM_ModeChange_FULL_COM_Entry_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: RCtApAFSControllerComM_ModeChange_FULL_COM_Entry
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
	...
	/* TODO */
	(void)Rte_Read_PpAmbientLight_DeAmbientLight(&ambientLight);
	(void)Rte_Read_PpSpeedometer_DeSpeedometer(&speedometer);
	...
	if (FALSE == highBeamModeSwitchState)
	{
		...
		if (ambientLight <= 5)
		{
			...
			else if (speedometer > 50 && speedometer <= 120)
			{
				/* COUNTRYMODE */
				/* TODO */
			...
			else if (speedometer > 120 && speedometer <= 250)
			{
				/* MOTORWAYMODE */
				/* TODO */
		...
		else
		{
			...
			if (FALSE == highBeamModeSwitchState)
			{
				if (ambientLight <= 5)
				{
					if (speedometer <= 50)
					{
						leftLightLength = CITYMODE_LENGTH_RIGHT;
						rightLightLength = CITYMODE_LENGTH_LEFT;
					}
					else if (speedometer > 50 && speedometer <= 120)
					{
						/* COUNTRYMODE */
