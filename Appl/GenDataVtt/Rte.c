...
VAR(IdtDioValueType, RTE_VAR_NOINIT) Rte_CpSaSpeedometer_PpSpeedometerOut_DeSpeedometer; /* PRQA S 0850, 3408, 1504 */ /* MD_MSR_19.8, MD_Rte_3408, MD_MSR_8.10 */
...
{
  Rte_Ev_Run_CpApAFSController_RCtApAFSControllerComM_FULL_COMM_Exit, /* COMM_FULL_COMMUNICATION */
...
CONST(EventMaskType, RTE_CONST) Rte_ModeEntryEventMask_CpApBatteryManager_PpBatteryMode_BatteryMode[3] =
{
  ...
  Rte_Ev_Run1_CpApAFSController_RCtApAFSControllerComM_ModeChange_FULL_COM_Entry, /* BATTERY_LOW */
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Start(void) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
  ...
  Rte_TriggerDisableFlags.Rte_Trigger_My_Task_Rte_Trigger1_CpApAFSController_RCtApAFSControllerComM_ModeChange_FULL_COM_Entry = 1U;
...
STATIC FUNC(void, RTE_CODE) Rte_IncDisableFlags_CpApBatteryManager_PpBatteryMode_BatteryMode(uint8 nextMode) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
  if (nextMode == RTE_MODE_BatteryMode_BATTERY_HIGH)
  {
    Rte_CheckDetErrorContinue(Rte_TriggerDisableFlags.Rte_Trigger_My_Task_Rte_Trigger1_CpApAFSController_RCtApAFSControllerComM_ModeChange_FULL_COM_Entry < Rte_TriggerDisableMaxCount_My_Task_Rte_Trigger1_CpApAFSController_RCtApAFSControllerComM_ModeChange_FULL_COM_Entry, RTE_INCDISABLEFLAGS_SERVICE_ID, RTE_E_DET_TRIGGERDISABLECOUNTER); /* PRQA S 3109 */ /* MD_MSR_14.3 */
    Rte_TriggerDisableFlags.Rte_Trigger_My_Task_Rte_Trigger1_CpApAFSController_RCtApAFSControllerComM_ModeChange_FULL_COM_Entry++;
  }
  else if (nextMode == RTE_MODE_BatteryMode_BATTERY_LOW) /* PRQA S 2004 */ /* MD_Rte_2004 */
  {
    Rte_CheckDetErrorContinue(Rte_TriggerDisableFlags.Rte_Trigger_My_Task_Rte_Trigger1_CpApAFSController_RCtApAFSControllerLogic < Rte_TriggerDisableMaxCount_My_Task_Rte_Trigger1_CpApAFSController_RCtApAFSControllerLogic, RTE_INCDISABLEFLAGS_SERVICE_ID, RTE_E_DET_TRIGGERDISABLECOUNTER); /* PRQA S 3109 */ /* MD_MSR_14.3 */
    Rte_TriggerDisableFlags.Rte_Trigger_My_Task_Rte_Trigger1_CpApAFSController_RCtApAFSControllerLogic++;
  }
  else if (nextMode == RTE_MODE_BatteryMode_BATTERY_MEDIUM) /* PRQA S 2004 */ /* MD_Rte_2004 */
  {
    Rte_CheckDetErrorContinue(Rte_TriggerDisableFlags.Rte_Trigger_My_Task_Rte_Trigger1_CpApAFSController_RCtApAFSControllerComM_ModeChange_FULL_COM_Entry < Rte_TriggerDisableMaxCount_My_Task_Rte_Trigger1_CpApAFSController_RCtApAFSControllerComM_ModeChange_FULL_COM_Entry, RTE_INCDISABLEFLAGS_SERVICE_ID, RTE_E_DET_TRIGGERDISABLECOUNTER); /* PRQA S 3109 */ /* MD_MSR_14.3 */
    Rte_TriggerDisableFlags.Rte_Trigger_My_Task_Rte_Trigger1_CpApAFSController_RCtApAFSControllerComM_ModeChange_FULL_COM_Entry++;
  }
...
STATIC FUNC(void, RTE_CODE) Rte_DecDisableFlags_CpApBatteryManager_PpBatteryMode_BatteryMode(uint8 previousMode) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
  if (previousMode == RTE_MODE_BatteryMode_BATTERY_HIGH)
  {
    Rte_CheckDetErrorContinue(Rte_TriggerDisableFlags.Rte_Trigger_My_Task_Rte_Trigger1_CpApAFSController_RCtApAFSControllerComM_ModeChange_FULL_COM_Entry > 0, RTE_DECDISABLEFLAGS_SERVICE_ID, RTE_E_DET_TRIGGERDISABLECOUNTER); /* PRQA S 3109 */ /* MD_MSR_14.3 */
    Rte_TriggerDisableFlags.Rte_Trigger_My_Task_Rte_Trigger1_CpApAFSController_RCtApAFSControllerComM_ModeChange_FULL_COM_Entry--;
  }
  else if (previousMode == RTE_MODE_BatteryMode_BATTERY_LOW) /* PRQA S 2004 */ /* MD_Rte_2004 */
  {
    Rte_CheckDetErrorContinue(Rte_TriggerDisableFlags.Rte_Trigger_My_Task_Rte_Trigger1_CpApAFSController_RCtApAFSControllerLogic > 0, RTE_DECDISABLEFLAGS_SERVICE_ID, RTE_E_DET_TRIGGERDISABLECOUNTER); /* PRQA S 3109 */ /* MD_MSR_14.3 */
    Rte_TriggerDisableFlags.Rte_Trigger_My_Task_Rte_Trigger1_CpApAFSController_RCtApAFSControllerLogic--;
  }
  else if (previousMode == RTE_MODE_BatteryMode_BATTERY_MEDIUM) /* PRQA S 2004 */ /* MD_Rte_2004 */
  {
    Rte_CheckDetErrorContinue(Rte_TriggerDisableFlags.Rte_Trigger_My_Task_Rte_Trigger1_CpApAFSController_RCtApAFSControllerComM_ModeChange_FULL_COM_Entry > 0, RTE_DECDISABLEFLAGS_SERVICE_ID, RTE_E_DET_TRIGGERDISABLECOUNTER); /* PRQA S 3109 */ /* MD_MSR_14.3 */
    Rte_TriggerDisableFlags.Rte_Trigger_My_Task_Rte_Trigger1_CpApAFSController_RCtApAFSControllerComM_ModeChange_FULL_COM_Entry--;
  }
...
FUNC(uint8, RTE_CODE) Rte_Mode_BswM_Notification_SWC_MODE_NOTIFICATION_BswM_MDGP_MdgBswMRequestBatteryMode_BswM_MDGP_BatteryMode(void) /* PRQA S 3408 */ /* MD_Rte_3408 */
{
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Switch_ComM_UM_USR_CHNL_CAN00_currentMode(uint8 nextMode) /* PRQA S 0850, 1505 */ /* MD_MSR_19.8, MD_MSR_8.10 */
{
  ...
  else
  {
    ...
    ModeSwitchEventMask = Rte_ModeExitEventMask_ComM_UM_USR_CHNL_CAN00_currentMode[currentMode];
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Switch_CtApBatteryManager_PpBatteryMode_BatteryMode(uint8 nextMode) /* PRQA S 0850, 1505 */ /* MD_MSR_19.8, MD_MSR_8.10 */
{
  ...
  else
  {
    ...
    {
      if ((nextMode == RTE_MODE_BatteryMode_BATTERY_HIGH) || (currentMode == RTE_MODE_BatteryMode_BATTERY_HIGH))
      {
        ModeSwitchEventMask |= Rte_Ev_MS_My_Task;
      }
      else if ((nextMode == RTE_MODE_BatteryMode_BATTERY_LOW) || (currentMode == RTE_MODE_BatteryMode_BATTERY_LOW)) /* PRQA S 2004 */ /* MD_Rte_2004 */
      {
        ModeSwitchEventMask |= Rte_Ev_MS_My_Task;
      }
      else
...
TASK(My_Task) /* PRQA S 3408, 1503 */ /* MD_Rte_3408, MD_MSR_14.1 */
{
  ...
  for(;;)
  {
    (void)WaitEvent(Rte_Ev_Run1_CpApAFSController_RCtApAFSControllerComM_ModeChange_FULL_COM_Entry | Rte_Ev_Run1_CpApAFSController_RCtApAFSControllerLogic | Rte_Ev_Run_CpApAFSController_RCtApAFSControllerComM_FULL_COMM_Exit | Rte_Ev_MS_My_Task); /* PRQA S 3417 */ /* MD_Rte_Os */
    (void)GetEvent(My_Task, &ev); /* PRQA S 3417 */ /* MD_Rte_Os */
    (void)ClearEvent(ev & (Rte_Ev_Run1_CpApAFSController_RCtApAFSControllerComM_ModeChange_FULL_COM_Entry | Rte_Ev_Run1_CpApAFSController_RCtApAFSControllerLogic | Rte_Ev_Run_CpApAFSController_RCtApAFSControllerComM_FULL_COMM_Exit | Rte_Ev_MS_My_Task)); /* PRQA S 3417 */ /* MD_Rte_Os */

    if (((ev & Rte_Ev_Run1_CpApAFSController_RCtApAFSControllerLogic) != (EventMaskType)0) && (Rte_TriggerDisableFlags.Rte_Trigger_My_Task_Rte_Trigger1_CpApAFSController_RCtApAFSControllerLogic == 0))
    {
      /* call runnable */
      RCtApAFSControllerLogic();
    }

    if ((ev & Rte_Ev_Run_CpApAFSController_RCtApAFSControllerComM_FULL_COMM_Exit) != (EventMaskType)0)
    {
      /* call runnable */
      RCtApAFSControllerComM_FULL_COMM_Exit();
    }

    if (((ev & Rte_Ev_Run1_CpApAFSController_RCtApAFSControllerComM_ModeChange_FULL_COM_Entry) != (EventMaskType)0) && (Rte_TriggerDisableFlags.Rte_Trigger_My_Task_Rte_Trigger1_CpApAFSController_RCtApAFSControllerComM_ModeChange_FULL_COM_Entry == 0))
    {
      /* call runnable */
      RCtApAFSControllerComM_ModeChange_FULL_COM_Entry();
    }

    if ((((ev & Rte_Ev_Run_CpApAFSController_RCtApAFSControllerComM_FULL_COMM_Exit) != (EventMaskType)0) || ((ev & Rte_Ev_MS_My_Task) != (EventMaskType)0)) && (Rte_ModeMachine_ComM_UM_USR_CHNL_CAN00_currentMode == RTE_TRANSITION_ComMMode))
    {
    ...
    if ((((ev & Rte_Ev_Run1_CpApAFSController_RCtApAFSControllerComM_ModeChange_FULL_COM_Entry) != (EventMaskType)0) || ((ev & Rte_Ev_MS_My_Task) != (EventMaskType)0)) && (Rte_ModeMachine_CpApBatteryManager_PpBatteryMode_BatteryMode == RTE_TRANSITION_BatteryMode))
    {
      uint8 previousMode;
      uint8 nextMode;
