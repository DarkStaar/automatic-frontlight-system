...
extern VAR(IdtDioValueType, RTE_VAR_NOINIT) Rte_CpSaSpeedometer_PpSpeedometerOut_DeSpeedometer; /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
#  define Rte_Enter_ExclusiveArea() \
  { \
...
# endif
FUNC(void, CtApAFSController_CODE) RCtApAFSControllerComM_FULL_COMM_Exit(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
FUNC(void, CtApAFSController_CODE) RCtApAFSControllerComM_ModeChange_FULL_COM_Entry(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
